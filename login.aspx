<%@ page language="C#" autoeventwireup="true" inherits="login, App_Web_hxd3xge2" %>
            ...
            <section class="container">
                <section class="form">
                    ...
                    <table>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Button ID="Button1" runat="server" Text="Take Test" CssClass="submit_button" onclick="Button1_Click"></asp:Button>
                            </td>
                        </tr>
                    </table>
                    </center>
